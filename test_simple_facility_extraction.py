...
def extract_facility_names_from_partner_facilities(partner_facilities_str):
    ...
    """
    if not partner_facilities_str or partner_facilities_str == '' or partner_facilities_str is None:
        return []
...
if __name__ == "__main__":
    success1 = test_extract_facility_name_from_filename()
    success2 = test_extract_facility_names_from_partner_facilities()
    test_integration()
